  ...
  >
    <div className="mx-auto max-w-[1400px]">
      <div className="flex flex-col justify-between gap-10 lg:flex-row lg:items-end">
        <div>
          <Logo className="h-24" testId="footer-logo-image" />
          <p className="mt-6 max-w-md font-serif text-lg italic leading-snug text-bone/55">
      ...
      <div className="mt-14 flex flex-col justify-between gap-3 border-t border-bone/10 pt-7 text-[11px] uppercase tracking-[0.16em] text-bone/35 sm:flex-row">
        <span>© {new Date().getFullYear()} NE Post &amp; Polish</span>
